 ...
 * 
 */
public abstract class AbstractIbatisDatabaseProcess implements
	...
	protected ICheckable<HashMap<String, Object>> checkable = new ICheckable<HashMap<String, Object>>() {
		...
		public boolean check(HashMap<String, Object> context)  throws ProcessException {
			return true;
		}
	 ...
	 * @return
	 */
	public abstract Object getParameter(HashMap<String, Object> context);
	...
	public boolean isInit() {
		return sqlMapClientTemplate != null;
	}
	...
	// @dynamic inject
	//
	public void setSqlMapClientTemplate(SqlMapClientTemplateManager sqlMapClientTemplateManager) {
		this.sqlMapClientTemplate = sqlMapClientTemplateManager.getTemplate(getDatabaseAlias());
	}
