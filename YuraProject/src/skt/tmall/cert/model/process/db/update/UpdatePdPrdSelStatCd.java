 ...
 *
 */
public class UpdatePdPrdSelStatCd extends AbstractIbatisUpdateProcess {
	
	private final String UPDATE_CERT_PDPRDSELSTATCD_103 = "cert.update.pdprdSelStatCd.103";

	@Override
	protected String getAlias() {
		return UPDATE_CERT_PDPRDSELSTATCD_103;
	}
