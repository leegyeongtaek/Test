...
/**
 * 외부인증번호 인증 상태 미인증 처리	(history 테이블(sm_cert_hist에는 인증취소(103) -> 미인증(101) 이 연속해서 들어감)
 * 
 ...
 *
 */
public class UpdateCoopCertStatusCancel extends AbstractIbatisUpdateProcess {
	
	public final static String CANCELYN = "_cancelYn";
	
	private final String CONFIRM_FAIL 			= "인증 취소 실패";
	
	private final String UPDATE_EXTERNAL_CERT_STATUS_CANCEL = "cert.update.external.certStatus.cancel";
	
	public UpdateCoopCertStatusCancel(){
	...
	protected String getAlias() {
		return UPDATE_EXTERNAL_CERT_STATUS_CANCEL;
	}
