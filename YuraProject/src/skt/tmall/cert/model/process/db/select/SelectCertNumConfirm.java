 ...
 * 인증가능상태 (501:배송완료, 901: 구매확정)
 * @author leegt80
 *
 */
public class SelectCertNumConfirm extends AbstractIbatisSelectObjectProcess<Map<String, Object>>{

	private final String SELECT_CERTNUM_CONFIRM = "cert.select.certnum.confirm";
	
	public SelectCertNumConfirm(){
		checkable = new ICheckable<HashMap<String,Object>>() {
			
			public boolean check(HashMap<String, Object> context)
					throws ProcessException {
				
				// 인증처리 시도중 발생한 로그 코드 && 반품거부 타입
