 ...
 *
 */
public class UpdateCertStatusConfirm extends AbstractIbatisUpdateProcess {
	
	private final String CONFIRM_FAIL 			= "인증 확인 실패";
	
	private final String UPDATE_CERT_STATUS_CONFIRM = "cert.update.certStatus.confirm";

	@Override
	protected String getAlias() {
		return UPDATE_CERT_STATUS_CONFIRM;
	}
