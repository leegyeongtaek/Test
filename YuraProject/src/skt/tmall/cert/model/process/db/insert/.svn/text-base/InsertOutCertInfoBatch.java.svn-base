 ...
 *
 */
public class InsertOutCertInfoBatch extends AbstractIbatisBatchProcess {
	
	private Log log = LogFactory.getLog(InsertOutCertInfoBatch.class);
	
	private final String INSERT_OUT_CERT_INFO = "cert.insert.out.info";
	
	@Override
	protected String getAlias() {
		return INSERT_OUT_CERT_INFO;
	}
